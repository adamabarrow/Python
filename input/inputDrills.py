'''
For this assignment you should read the task, then below the task do what it 
asks you to do.

EXAMPLE TASK:
'''
#EX) Get input from the user to the question "What is your favorite color?"
...
instructor = input("What is yout instructors name?")
